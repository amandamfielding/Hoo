...
image_url:"http://res.cloudinary.com/dbsxgncvx/image/upload/c_fill,h_400,w_400/v1480576832/demo_profile_pic_l6t2lm.jpg", resume_url:"http://res.cloudinary.com/dbsxgncvx/image/upload/v1481874874/amanda_fielding_resume_u5vdje.pdf", about_me:"Software Engineer looking for a front end position. I'm pretty fun to work with, I swear.")
...
Request.create!(event_id:1,user_id:1)
Request.create!(event_id:1,user_id:3)
Request.create!(event_id:1,user_id:4)
Request.create!(event_id:1,user_id:5)
Request.create!(event_id:2,user_id:6)
Request.create!(event_id:2,user_id:4)
Request.create!(event_id:2,user_id:7)
Request.create!(event_id:3,user_id:8)
Request.create!(event_id:3,user_id:1)
Request.create!(event_id:4,user_id:8)
Request.create!(event_id:4,user_id:2)
Request.create!(event_id:4,user_id:3)
Request.create!(event_id:4,user_id:4)
Request.create!(event_id:4,user_id:5)
Request.create!(event_id:4,user_id:6)
Request.create!(event_id:5,user_id:7)
Request.create!(event_id:5,user_id:8)
Request.create!(event_id:6,user_id:1)
Request.create!(event_id:6,user_id:2)
Request.create!(event_id:7,user_id:3)
Request.create!(event_id:7,user_id:4)
Request.create!(event_id:7,user_id:5)
Request.create!(event_id:7,user_id:6)
Request.create!(event_id:8,user_id:7)
Request.create!(event_id:8,user_id:8)
Request.create!(event_id:8,user_id:1)
Request.create!(event_id:9,user_id:2)
Request.create!(event_id:9,user_id:3)
Request.create!(event_id:9,user_id:5)
Request.create!(event_id:9,user_id:4)
Request.create!(event_id:9,user_id:6)
Request.create!(event_id:10,user_id:8)
Request.create!(event_id:10,user_id:7)
Request.create!(event_id:10,user_id:1)
Request.create!(event_id:11,user_id:2)
Request.create!(event_id:11,user_id:3)
Request.create!(event_id:11,user_id:4)
Request.create!(event_id:12,user_id:5)
Request.create!(event_id:12,user_id:6)
Request.create!(event_id:13,user_id:5)
Request.create!(event_id:13,user_id:4)
Request.create!(event_id:14,user_id:6)
Request.create!(event_id:14,user_id:7)
Request.create!(event_id:15,user_id:8)
Request.create!(event_id:15,user_id:1)
Request.create!(event_id:16,user_id:2)
Request.create!(event_id:16,user_id:3)
Request.create!(event_id:17,user_id:4)
Request.create!(event_id:17,user_id:5)
Request.create!(event_id:18,user_id:6)
Request.create!(event_id:18,user_id:7)
Request.create!(event_id:18,user_id:8)
Request.create!(event_id:18,user_id:1)
Request.create!(event_id:19,user_id:2)
Request.create!(event_id:19,user_id:3)
Request.create!(event_id:18,user_id:4)
Request.create!(event_id:18,user_id:5)
Request.create!(event_id:19,user_id:6)
Request.create!(event_id:19,user_id:7)
Request.create!(event_id:19,user_id:8)
Request.create!(event_id:19,user_id:1)
Request.create!(event_id:20,user_id:3)
Request.create!(event_id:20,user_id:4)
Request.create!(event_id:20,user_id:5)
Request.create!(event_id:20,user_id:6)
Request.create!(event_id:20,user_id:7)
Request.create!(event_id:21,user_id:8)
Request.create!(event_id:21,user_id:1)
Request.create!(event_id:21,user_id:2)
Request.create!(event_id:21,user_id:3)
Request.create!(event_id:21,user_id:4)
Request.create!(event_id:22,user_id:5)
Request.create!(event_id:23,user_id:6)
Request.create!(event_id:22,user_id:7)
Request.create!(event_id:22,user_id:8)
Request.create!(event_id:23,user_id:1)
Request.create!(event_id:23,user_id:2)
Request.create!(event_id:24,user_id:3)
Request.create!(event_id:24,user_id:4)
Request.create!(event_id:24,user_id:5)
Request.create!(event_id:24,user_id:6)
Request.create!(event_id:25,user_id:7)
Request.create!(event_id:26,user_id:8)
Request.create!(event_id:27,user_id:1)
Request.create!(event_id:27,user_id:2)
Request.create!(event_id:27,user_id:3)
Request.create!(event_id:28,user_id:4)
Request.create!(event_id:28,user_id:5)
Request.create!(event_id:28,user_id:6)
Request.create!(event_id:28,user_id:7)
